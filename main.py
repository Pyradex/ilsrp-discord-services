...
# Get Discord token from environment variables (supports multiple variable names)
def get_token():
    ...
    if not token:
        raise ValueError(
            "No Discord token found! Please set one of the following environment variables:\n"
            "  - DISCORD_TOKEN\n"
            "  - TOKEN\n"
            "\n"
            "On Render, go to your service's Environment variables and add DISCORD_TOKEN with your bot token."
        )
    return token
